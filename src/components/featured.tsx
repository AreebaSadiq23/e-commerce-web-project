  ...
  const cardData = [
    {
      ...
      description: "We focus on ergonomic design and meeting you where you work. It's only a keystroke away.",
    },
    {
    ...
    <div className="py-20 px-4 bg-gray-50 max-w-screen-2xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-10">
        {cardData.map((card, index) => (
          <div key={index} className="bg-white rounded-lg shadow-lg overflow-hidden relative group">
            <Image
              src={card.image}
              alt="Featured Image"
              width={500}
            ...
            <div className="p-4">
              ...
              <h4 className="text-4xl font-semibold text-gray-800 mt-6">{card.title}</h4>
